					...
					<div className="flex flex-col flex-wrap text-center lg:py-6 lg:w-1/2 lg:pl-12 lg:text-left">
						...
						<div className="w-full p-1">
							<div className="flex items-center h-full p-2 text-2xl rounded">
								...
								<span className="font-bold title-font text-gray-800">
									Perfect taste
								</span>
							</div>
						</div>
							...
							<div className="flex flex-wrap space-y-6 md:space-y-0">
								<div className="flex flex-col items-center text-center p-4 md:w-1/3">
									...
									<div className="flex-grow">
										...
										<p className="text-base leading-relaxed text-gray-800 ">
											As easy as 1, 2, 3. Just select your
											favorite pizza and place your order.
										</p>
									</div>
								</div>
								<div className="flex flex-col items-center text-center p-4 md:w-1/3">
									...
									<div className="flex-grow">
										...
										<p className="text-base leading-relaxe text-gray-800">
											Pick up your order from the nearest
											store or get it delivered to your
											doorstep.
										</p>
									</div>
								</div>
								<div className="flex flex-col items-center text-center p-4 md:w-1/3">
									...
									<div className="flex-grow">
										...
										<p className="text-base leading-relaxed text-gray-800">
											As soon as you get your order, enjoy
											the delicious pizza with your loved
											ones.
										</p>
									</div>
								</div>
